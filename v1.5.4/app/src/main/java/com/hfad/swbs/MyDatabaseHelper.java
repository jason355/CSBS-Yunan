...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        createTableQuery = "CREATE TABLE if not exists " +
                "initData (id INTEGER PRIMARY KEY AUTOINCREMENT, classNumber varchar(5) UNIQUE, messageStat int DEFAULT 0, haveCountDown int DEFAULT 0, counting int DEFAULT 0, canUpgrade int DEFAULT -1)";
        db.execSQL(createTableQuery);
    }
